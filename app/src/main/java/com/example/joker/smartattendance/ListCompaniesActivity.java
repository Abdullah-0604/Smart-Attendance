...
public class ListCompaniesActivity extends Activity implements AdapterView.OnItemLongClickListener, AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Log.d(TAG, "clickedItem : "+clickedCompany.getdName());
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        Company clickedCompany = mAdapter.getItem(position);
        Log.d(TAG, "longClickedItem : "+clickedCompany.getdName());
    ...
    private void showDeleteDialogConfirmation(final Company clickedCompany) {
        ...
        alertDialogBuilder.setMessage("Are you sure you want to delete the \""+clickedCompany.getdName()+"\" Department ?");
